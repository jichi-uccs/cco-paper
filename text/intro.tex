...
determine (with developer guidance) both the profitability and safety of the overlapping optimization. %, although with some small amount of manual assistance from developers. 
